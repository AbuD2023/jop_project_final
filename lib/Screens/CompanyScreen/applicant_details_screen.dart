...
class ApplicantDetailsScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    // final dd = orderProvider.ordersByCompany.indexWhere((element) => element.jobAdvertisementId == job?.id &&
                              ...
                              if (orderUser.accept == 0) {
                                ...
                                await orderProvider
                                  ...
                                  (value) async {
                                    ...
                                    final tok =
                                        searcher.tokenNotification.toString();
                                    log(tok.toString(),
                                        name: 'searcher.tokenNotification');
                      ...
                      if (orderUser.accept == 0) {
                        ...
                        await orderProvider
                          ...
                          (value) async {
                            ...
                            final tok = searcher.tokenNotification.toString();
                            log(tok.toString(),
                                name: 'searcher.tokenNotification');
                            await SendNotificationsService
                                .sendNotificationForSingleUserUsingApi(
                                    ...
                                    title: "لقد تم قبولك في الوظيفة",
                                    body:
                                        "تم قبولك في وظيفة ${job?.nameJob} في شركة ${context.read<CompanySigninLoginProvider>().currentCompany?.nameCompany} قم بالتواصل بالشركة",
                                    data: {
                                  "screen": 'Chat',
                                  // "userType": 'Searcher',
                                  // "userId": searcher.id

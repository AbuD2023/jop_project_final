        ...
        Row(
          ...
          children: [
            ...
            CustomPopupMenu(
              ...
              onClickMenu: (item) {
                context.read<OrderProvider>().searchOrderByCompany(
                    item.menuTitle,
                    context
                            .read<CompanySigninLoginProvider>()
                            .currentCompany
                          ...
                          return Card(
                            ...
                            child: Directionality(
                                ...
                                child: ListTile(
                                  ...
                                  title: Text(
                                    '${searcher?.fullName}: ${orderCount[index].jobAdvertisement != null ? orderCount[index].jobAdvertisement?.nameJob : orderCount[index].jobAdvertisement?.nameJob}',
                                    ...
                                    Navigator.push(
                                      ...
                                      MaterialPageRoute(
                                        builder: (context) =>
                                          ...
                                          job: orderCount[index]
                                              .jobAdvertisement,
                                          searcher: orderCount[index].searcher!,
                                          orderUser: orderCount[index],
                                        ),
                                      ),
                                    );
                                  },

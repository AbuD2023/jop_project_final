        ...
        children: [
          ...
          TextFormField(
            ...
            validator: (value) {
              ...
              if (value.length < 9) {
                return 'يجب ان يكون 9 ارقم';
              }
              if (value.length > 9) {
                return 'لا يمكن ان يكون اكثر من 9 ارقم';
              }
              return null;
            },
            maxLength: 9,
            buildCounter: (context,
                ...
                required isFocused,
                required maxLength}) {
              log(currentLength.toString(), name: 'currentLength');
              log(maxLength.toString(), name: 'maxLength');
              return null;
            },
            onChanged: (value) {
              // phoneOneController.text =
              //     value.indexOf('+') == 0 ? value : '+967 $value';
              log(value.length.toString(), name: 'value.length');

...
import '../../../Controller/Firebase_Services/notifications_service.dart';
                            ...
                            (value) async {
                              ...
                              await SendNotificationsService
                                  .sendNotificationForSingleUserUsingApi(
                                      ...
                                      body:
                                          "مقدم جديد للوظيفة ${jobData.nameJob}",
                                      data: {
                                    "screen": 'OrderScreen',
                                    // "userType": 'Admin',
                              ...
                              //         title:
                              //             "مرحباً شركة ${_currentCompany?.nameCompany}",
                              ...
                              String tokenNotificationsDevice =
                                  (await notificationsService
                                      .getDeviceToken())!;
                              unawaited(SendNotificationsService
                                  .sendNotificationForSingleUserUsingApi(
                                token: tokenNotificationsDevice,
                                title: l10n.havemessage,
                                body: "تم التقديم الى وظيفة ${jobData.nameJob}",
                                data: {
                                  "screen": 'OrderScreen',
                                  // "userType": 'Searcher',
                                  // "userId":
